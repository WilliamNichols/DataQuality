...
dbGetQuery( con,
            ...
            , 'removed_phase_name'
            , 'removed_phase_ordinal'
            , 'removed_base_phase_name'
            , 'removed_base_phase_ordinal'
            , 'removed_phase_type'
            , 'defect_injected_phase_key' 
            , 'injected_phase_name'
            , 'injected_phase_ordinal'
            , 'injected_base_phase_name'
            , 'injected_base_phase_ordinal'
            , 'injected_phase_type'
